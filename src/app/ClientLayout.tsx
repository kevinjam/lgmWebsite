...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  const [isFFCRoute, setIsFFCRoute] = useState(false);

  useEffect(() => {
    setIsFFCRoute(pathname?.startsWith('/ffc') ?? false);
  }, [pathname]);
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between px-4 text-sm sm:text-base">
          <span className="flex items-center space-x-2 mb-2 sm:mb-0">
            ...
            <span>The glory of this present house will be greater than the glory of the former house</span>
          </span>
           <div className="flex space-x-4 hidden sm:flex">
              ...
              <Link href="https://x.com/LGM_UG" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
